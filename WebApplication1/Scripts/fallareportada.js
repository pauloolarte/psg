...
function listarFallaReportada() {
    objetoConf = {
        url: "FallaReportada/listarFallaReportada/?fechainicio=&fechafin=&numOS=&Estado=&idUsrCreacion=0",   id: "divTabla",
...
function listarHistorialEstados(IdFalla) {
    objetoConf = {
